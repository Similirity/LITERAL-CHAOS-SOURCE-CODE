	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'parents-christmas':
				...
				if (Main.god) tex = Paths.getSparrowAtlas('god_tricky');
				frames = tex;

				if (Main.god)
				{
				animation.addByPrefix('idle', "Idle", 25, false);
				animation.addByPrefix('singUP', "Sing Up", 30, false);
				animation.addByPrefix('singDOWN', "Sing Down", 30, false);
				animation.addByPrefix('singLEFT', 'Sing Left', 30, false);
				animation.addByPrefix('singRIGHT', 'Sing Right', 30, false);
				
				addOffset('idle');
				addOffset("singUP", 102, 3);
				addOffset("singRIGHT", 24, -80);
				addOffset("singLEFT", 132, 18);
				...
				if (Main.god) tex = Paths.getSparrowAtlas('god_bob');
				...
				case 'whitty':
				tex = Paths.getSparrowAtlas('whitty');
				if (Main.god) tex = Paths.getSparrowAtlas('god_whitty');
				frames = tex;
				if (Main.god)
				{
					...
					addOffset('idle', 0);
					addOffset("singUP", 0, 119);
					addOffset("singRIGHT", 91, -70);
					addOffset("singLEFT", 62, 59);
					addOffset("singDOWN", 86, -133);
				}
				else
				{
				...
				if (Main.god) tex = Paths.getSparrowAtlas('god_zardy');
				frames = tex;
				animation.addByPrefix('idle', 'Idle', 14);
				animation.addByPrefix('singUP', 'Sing Up', 20);
				animation.addByPrefix('singRIGHT', 'Sing Right', 20);
				animation.addByPrefix('singDOWN', 'Sing Down', 20);
				animation.addByPrefix('singLEFT', 'Sing Left', 20);

				addOffset('idle');
				addOffset("singUP", -88, 2);
				addOffset("singRIGHT", -60, -6);
				addOffset("singLEFT", 131, 7);
				addOffset("singDOWN", -12, -23);

				case 'agoti':
				tex = Paths.getSparrowAtlas('AGOTI');
				frames = tex;
				animation.addByPrefix('idle', 'Agoti_Idle', 14);
				animation.addByPrefix('singUP', 'Agoti_Up', 20);
				animation.addByPrefix('singRIGHT', 'Agoti_Right', 20);
				animation.addByPrefix('singDOWN', 'Agoti_Down', 20);
				animation.addByPrefix('singLEFT', 'Agoti_Left', 20);
				...
				case 'tabi':
				frames = Paths.getSparrowAtlas('TABI');
				...
				addOffset('idle', 588, -102);

				addOffset("singUP", 644, -60);
				addOffset("singRIGHT", 545, -101);
				addOffset("singLEFT", 715, -139);
				addOffset("singDOWN", 585, -138);
