	...
	override function create()
	{
		...
		*/
		...
		isDebug = true;
			...
			addWeek(['Final-destination', 'Final-destination', 'Final-destination'], 1, ['both', 'both', 'both']);
		...
		{
			var songText:Alphabet = new Alphabet(0, (7000 * i) + 30, songs[i].songName, true, false);
