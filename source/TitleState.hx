...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		logoBl = new FlxSprite(-150, -40).loadGraphic(Paths.image('logoBumpin'));
		logoBl.antialiasing = true;
		logoBl.setGraphicSize(Std.int(logoBl.frameWidth * 0.4));
		logoBl.updateHitbox();
	...
	override function beatHit()
	{
		...
		{
            case 3:
            	createCoolText(['Mod by', 'perez', 'sulayre', 'theonlyvolume', 'joan atlas', 'and me lol']);
            case 10:
            	deleteCoolText();
                createCoolText(["with help from thezoroforce240"]);
            case 17:
            	skipIntro();
